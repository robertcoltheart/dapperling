...
public static class DbConnectionExtensions
{
        ...
        where T : class
    {
        ...
        {
            var result = connection.QueryFirst<long>(sql, entity, transaction, commandTimeout: commandTimeout);
        ...
        where T : class
    {
        ...
        if (keyProperties.Any())
        {
            var result = await connection.QueryFirstAsync<long>(sql, entity, transaction, commandTimeout: commandTimeout).ConfigureAwait(false);
